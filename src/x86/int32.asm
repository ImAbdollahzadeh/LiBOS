...
section .text
	...
	reloc: use32                               ;                                                                                                    ; %*% From here on gets copy startting from INT32_BASE
		...
		lodsd                                  ; read intnum into eax and increement esi by 4 bytes                                                 ;
...
;-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+       ;
                                                                                                                                                    ;
                                                                                                                                                    ;
;                                                  values for both 16-bit and 32-bit                                                                ;
                                                                                                                                                    ;
                                                                                                                                                    ;
;-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+       ;
;-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+		;
...
;gdt32_ptr:      
;	dw BIOS_CALL_GDT_LIMIT  
;	dd BIOS_CALL_GDT_BASE

;idt32_ptr:      
;	dw BIOS_CALL_IDT_LIMIT  
;	dd BIOS_CALL_IDT_BASE
